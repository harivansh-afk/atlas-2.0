...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @xml_schema(
        ...
        <parameter name="query">what is Atlas AI and what are they building?</parameter>
    ...
    @xml_schema(
        ...
        <parameter name="urls">https://www.Atlas.ai/,https://github.com/Atlas-ai/Atlas</parameter>
        </invoke>
        </function_calls>
        '''
    )
