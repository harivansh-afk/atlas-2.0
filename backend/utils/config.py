...
class Configuration:
    ...
    LLM_RATE_LIMIT_DELAY: int = 30
    LLM_OVERLOAD_DELAY: int = (
        45  # Reduced initial delay but will use exponential backoff
    )
    LLM_RETRY_DELAY: float = 0.1
    LLM_ENABLE_FALLBACK: bool = True  # Enable fallback models on overload
    ...
    TAVILY_API_KEY: str
    RAPID_API_KEY: str
    CLADO_API_KEY: Optional[str] = None
