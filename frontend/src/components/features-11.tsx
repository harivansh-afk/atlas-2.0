    ...
    return (
        <section className="py-8 md:py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mx-auto grid gap-2 sm:grid-cols-15">
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-9 sm:rounded-none sm:rounded-tl-xl border border-border rounded-2xl bg-background/80">
                        <div className="p-8">
                            <h3 className="text-xl md:text-2xl font-medium">Connect all your apps</h3>
                        ...
                        <div className="relative mt-4 px-6 pb-6">
                            <div className="absolute inset-x-0 bottom-6 h-48 bg-gradient-to-t from-background to-transparent z-10"></div>
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-6 sm:rounded-none sm:rounded-tr-xl border border-border rounded-2xl bg-background/80">
                        <div className="p-8">
                            <h3 className="text-xl md:text-2xl font-medium">Build your agents</h3>
                            <p className="text-muted-foreground mt-2 text-sm">Create powerful AI agents tailored to your specific needs and workflows.</p>
                        </div>

                        <div className="relative mt-4 px-6 pb-6">
                            <div className="absolute inset-x-0 bottom-6 h-48 bg-gradient-to-t from-background/90 to-transparent z-10"></div>
                            <div className="relative w-full overflow-hidden rounded-2xl border">
                    ...
                    <Card className="group shadow-zinc-950/5 sm:col-span-6 sm:rounded-none border border-border rounded-2xl bg-background/80">
                        <div className="p-8">
                            <h3 className="text-xl md:text-2xl font-medium">Start knocking out tasks</h3>
                    ...
                    <Card className="group relative shadow-zinc-950/5 sm:col-span-9 sm:rounded-none border border-border rounded-2xl bg-background/80">
                        ...
                        <div className="px-6 pb-12">
                            <div className="flex gap-6 items-center justify-center">
                                <div className="rounded-lg bg-muted/50 flex aspect-square size-16 items-center justify-center border p-4 hover:scale-105 transition-transform">
                                    <img
                                ...
                                <div className="rounded-lg bg-muted/50 flex aspect-square size-16 items-center justify-center border p-4 hover:scale-105 transition-transform">
                                    <Plus className="m-auto size-8 text-foreground" />
                                </div>
                            </div>
                        </div>
                    </Card>

                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-5 sm:rounded-none sm:rounded-bl-xl border border-border rounded-2xl bg-background/80">
                        <div className="p-8">
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-5 sm:rounded-none border border-border rounded-2xl bg-background/80">
                        <div className="p-8">
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-5 sm:rounded-none sm:rounded-br-xl border border-border rounded-2xl bg-background/80">
                        <div className="p-8">
