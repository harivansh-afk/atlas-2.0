      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-base text-muted-foreground">
            Atlas is fully open source. Join our community and help shape the
            future of AI agents.
          </p>
        </SectionHeader>
          ...
          <div className="rounded-xl bg-[var(--features-card-bg)] border border-border p-6">
            <div className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <p className="text-base text-muted-foreground">
                  Explore, contribute, or fork our repository. Atlas is built
              ...
              <Link
                href="https://github.com/Atlas-ai/Atlas"
                target="_blank"
