...
const CpuArchitecture = ({
  ...
  const isWireActive = (idx: number) =>
    !animatedWireIndexes || animatedWireIndexes.includes(idx);
  return (
    <svg
    ...
    >
      ...
      <g mask="url(#cpu-mask-1)">
        <circle
          className={cn("cpu-architecture cpu-line-1", isWireActive(0) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-2)">
        <circle
          className={cn("cpu-architecture cpu-line-2", isWireActive(1) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-3)">
        <circle
          className={cn("cpu-architecture cpu-line-3", isWireActive(2) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-4)">
        <circle
          className={cn("cpu-architecture cpu-line-4", isWireActive(3) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-5)">
        <circle
          className={cn("cpu-architecture cpu-line-5", isWireActive(4) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-6)">
        <circle
          className={cn("cpu-architecture cpu-line-6", isWireActive(5) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-7)">
        <circle
          className={cn("cpu-architecture cpu-line-7", isWireActive(6) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <g mask="url(#cpu-mask-8)">
        <circle
          className={cn("cpu-architecture cpu-line-8", isWireActive(7) && "cpu-animate")}
          cx="0"
          cy="0"
          r="8"
      ...
      <defs>
        ...
        <radialGradient id="cpu-blue-grad" fx="1">
          ...
          <stop offset="30%" stopColor="#00E8ED" stopOpacity="1" />
          <stop offset="70%" stopColor="#08F" stopOpacity="0.8" />
          <stop offset="100%" stopColor="transparent" stopOpacity="0" />
        </radialGradient>
        <radialGradient id="cpu-yellow-grad" fx="1">
          <stop offset="0%" stopColor="#fff" stopOpacity="1" />
          <stop offset="30%" stopColor="#FFD800" stopOpacity="1" />
          <stop offset="70%" stopColor="#FFD800" stopOpacity="0.8" />
          <stop offset="100%" stopColor="transparent" stopOpacity="0" />
        </radialGradient>
        <radialGradient id="cpu-pinkish-grad" fx="1">
          <stop offset="0%" stopColor="#fff" stopOpacity="1" />
          <stop offset="30%" stopColor="#FF008B" stopOpacity="1" />
          <stop offset="70%" stopColor="#830CD1" stopOpacity="0.8" />
          <stop offset="100%" stopColor="transparent" stopOpacity="0" />
        </radialGradient>
