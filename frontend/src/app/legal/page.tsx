                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY Atlas AI
                      Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                      United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE Atlas
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to Atlas AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the Atlas website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the Atlas website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@Atlas.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@atlasagents_ai.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@atlasagents_ai.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All Atlas logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE Atlas WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      Atlas DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@atlasagents_ai.com"
                        className="text-secondary hover:underline"
                      >
                        legal@atlasagents_ai.com
                      </a>
                      .
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at Atlas in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      Atlas does not collect biometric or identifying
