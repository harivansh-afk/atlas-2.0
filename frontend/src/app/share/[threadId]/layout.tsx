...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Atlas Atlas',
    description: 'Replay this Agent conversation on Atlas Atlas',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Atlas Atlas';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Atlas Atlas';
